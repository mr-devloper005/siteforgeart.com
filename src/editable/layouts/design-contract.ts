...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#171719',
  '--slot4-panel-bg': '#fff4ed',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#8b8d95',
  '--slot4-soft-muted-text': '#a2a4ab',
  '--slot4-accent': '#f58652',
  '--slot4-accent-fill': '#f58652',
  '--slot4-accent-soft': '#fff0e8',
  '--slot4-dark-bg': '#1f1f20',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#f6f6f6',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#fafafa',
  '--slot4-lavender': '#fff4ed',
  '--slot4-gray': '#f8f8f8',
  '--slot4-line': '#eeeeee',
  '--slot4-dark-pattern': '#1f1f20',
  '--slot4-body-gradient': 'linear-gradient(180deg, #ffffff 0%, #fafafa 46%, #ffffff 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  ...
  button: {
    primary: `inline-flex items-center justify-center rounded-full ${editablePalette.accentBg} px-8 py-3.5 text-sm font-bold text-white shadow-[0_12px_28px_rgba(245,134,82,0.28)] transition hover:-translate-y-0.5 hover:shadow-[0_16px_36px_rgba(245,134,82,0.34)]`,
