...
export const pagesContent = {
  home: {
    metadata: {
      title: 'Visual portfolios and creative profiles',
      description: 'Explore image-led posts, portfolio stories, professional profiles, and visual resources in one polished browsing experience.',
      openGraphTitle: 'Visual portfolios and creative profiles',
      openGraphDescription: 'Discover creative portfolios, image posts, professional profiles, and connected visual resources.',
      keywords: ['visual portfolios', 'creative profiles', 'image gallery', 'portfolio discovery'],
    },
    hero: {
      badge: 'Latest visual showcases',
      title: ['A polished home for', 'portfolios, profiles, and visual discovery.'],
      description: 'Explore fresh image-led posts, creative profiles, and discoverable portfolio content through a refined browsing experience.',
      primaryCta: { label: 'Browse visual posts', href: '/image' },
      secondaryCta: { label: 'Explore visuals', href: '/image' },
      searchPlaceholder: 'Search portfolios, visuals, profiles, and more',
      focusLabel: 'Focus',
